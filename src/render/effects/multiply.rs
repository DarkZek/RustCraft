...
// Merges two textures
pub struct MultiplyPostProcessingEffect {
...
impl MultiplyPostProcessingEffect {
    pub fn new() -> MultiplyPostProcessingEffect {
        ...
        let render_pipeline_layout =
            get_device().create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                label: Some("Multiply effect pipeline layout descriptor"),
        ...
        let render_pipeline =
            get_device().create_render_pipeline(&wgpu::RenderPipelineDescriptor {
                label: Some("Multiply effect pipeline"),
    ...
    pub fn multiply(
        ...
        let bind_group = get_device().create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("Multiply Effect Bind Group"),
        ...
        let mut pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
            label: Some("Multiply Render Pass Stage"),
